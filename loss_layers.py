...
class SSIM(nn.Module):
    def __init__(self) -> None:
        ...
        self.mean_x_pool = nn.AdaptiveAvgPool2d(3, 1)
        self.mean_y_pool = nn.AdaptiveAvgPool2d(3, 1)
        self.var_x_pool = nn.AdaptiveAvgPool2d(3, 1)
        self.var_y_pool = nn.AdaptiveAvgPool2d(3, 1)
        self.cov_xy_pool = nn.AdaptiveAvgPool2d(3, 1)
